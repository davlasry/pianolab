...
import type {
    KeyColor,
    CustomKeyProps,
} from "@/components/SessionView/Keyboard/types.ts";
            ...
            <defs>
                ...
                >
                    ...
                    <feBlend
                        mode="normal"
                        in2="shape"
                        result="effect1_innerShadow_218_4103"
                    />
                    <feColorMatrix
                        in="SourceAlpha"
                        type="matrix"
                    ...
                    <feBlend
                        mode="normal"
                        in2="effect1_innerShadow_218_4103"
                        result="effect2_innerShadow_218_4103"
                    />
                    <feColorMatrix
                        in="SourceAlpha"
                        type="matrix"
                    ...
                    <feBlend
                        mode="normal"
                        in2="effect2_innerShadow_218_4103"
                        result="effect3_innerShadow_218_4103"
                    />
                    <feColorMatrix
                        in="SourceAlpha"
                        type="matrix"
                    ...
                    <feBlend
                        mode="normal"
                        in2="effect3_innerShadow_218_4103"
                        result="effect4_innerShadow_218_4103"
                    />
                </filter>
                <linearGradient
...
const blackKeyVariants = {
    default: (
        <>
            <path
                d="M0 0H38V251C38 252.105 37.1046 253 36 253H2C0.89543 253 0 252.105 0 251V0Z"
                fill="black"
            />
            <path
            ...
            />
            <path
                d="M32.5349 215.5L34.9625 249H3.03754L5.46508 215.5H32.5349Z"
                fill="#242424"
                stroke="#191919"
            />
            <g filter="url(#filter0_f_17_219)">
                <path
                    d="M7 233.5L6 219.5L15 216V235.5L7 233.5Z"
                    fill="white"
                    fillOpacity="0.8"
                />
            </g>
            <g filter="url(#filter1_f_17_219)">
                <path
                    d="M25.5 234V224.5H31.5L32 233.5L25.5 234Z"
                    fill="white"
                    fillOpacity="0.1"
                />
            </g>
            ...
            <defs>
                ...
                >
                    ...
                    <feGaussianBlur
                        stdDeviation="2"
                        result="effect1_foregroundBlur_17_219"
                    />
                </filter>
                <filter
                    id="filter1_f_17_219"
    ...
    active: (
        <>
            ...
            />
            <path
                d="M33.5211 224.5L34.5779 249H3.42194L4.47885 224.5H33.5211Z"
                fill="#242424"
                stroke="#191919"
            />
            <g filter="url(#filter0_f_26_448)">
                <path
                    d="M7 246.5L6 232.5L15 229V248.5L7 246.5Z"
                    fill="white"
                    fillOpacity="0.8"
                />
            </g>
            <g filter="url(#filter1_f_26_448)">
                <path
                    d="M27.5 248V238.5H33.5L34 247.5L27.5 248Z"
                    fill="white"
                    fillOpacity="0.1"
                />
            </g>
            ...
            <defs>
                ...
                >
                    ...
                    <feGaussianBlur
                        stdDeviation="2"
                        result="effect1_foregroundBlur_26_448"
                    />
                </filter>
                <filter
                    id="filter1_f_26_448"
